...
import styles from './TableNewProducts.module.css'
import Swal from 'sweetalert2'
import Table from 'react-data-table-component'
import { DeleteOutlined, EditOutlined } from '@ant-design/icons'
import ModalNewProducts from '../modalNewProducts/ModalNewProducts'
const TableNewProducts = () => {
    ...
    return (
        ...
        <ModalNewProducts isOpen={isOpenModal} onClosed={()=> setIsOpenModal(false)} titleModal="updateQuestion"/>
