...
import SearchNewProducts from '../../components/SearchNewProducts/SearchNewProducts';
import CartSidebar from '../../../cart/components/CartSidebar';
import {listProducts,productByName} from '../../services/productsApi';
import PaginationNewProduts from '../PaginationNewProducts/PaginationNewProducts';
const ContentNewProducts = ({categorie}) => {
    ...
    console.log(isOpen,productSelected);
    // estado para tachar el precio actual si hay dscto en el producto
    ...
    return (
        <>
        <SearchNewProducts recibirTextInput={recibirTextSearch} recibirValuePrecio={recibirFiltroPrecio} recibirCategories={recibirFiltroCat} products={allProducts}/>
        <div className={styles.containerProducts}>
                <section className={styles.contentProducts} >
                    ...
                    {totalPages && <PaginationNewProduts numPage = { totalPages } handlerPagina={recibirPagina} nextPage={pageNext}/>}
