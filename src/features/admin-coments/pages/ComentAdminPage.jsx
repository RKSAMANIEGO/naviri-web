...
import { Form, Input, Button, Modal, Table, FloatButton, DatePicker, Col, Row, Upload, message } from 'antd';
import { UploadOutlined, PlusOutlined, DeleteOutlined } from '@ant-design/icons';
import { useCommentAdmin } from '../hooks/useComentAdmin';
import dayjs from 'dayjs';
import CommentSearch from '../components/ComentAdmin'; // <-- nuevo
...
const ComentAdminPage = () => {
  ...
  useEffect(() => {
    const results = comments.filter(comment =>
      comment?.name_customer?.toLowerCase?.().includes(searchQuery) || false
    );
