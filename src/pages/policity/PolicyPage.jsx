...
import { getPolicies } from '../../service/policityService'
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#F9F6FB] to-[#FFF5F9] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16 text-center">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4 font-serif mx-auto max-w-3xl">
            {policy.title}
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden max-w-3xl mx-auto">
          <div className="p-8 md:p-12 lg:p-16">
            <div className="prose lg:prose-lg max-w-none text-gray-700 mx-auto">
              <div 
